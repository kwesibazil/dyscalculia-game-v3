      ...
      <nav class="navbar navbar-light py-0 h-100 px-xl-3 ">
        <div class="d-flex flex-column justify-content-between h-100 ">
          <ul class="navbar-nav d-flex flex-column justify-content-between h-50">
            <li @click="toggleSideNav" class="nav-item px-6 py-2 hvr-shadow mt-3 "><!-- mt-md-3 -->
              <router-link class="nav-link active d-flex align-items-center justify-content-center" aria-current="page" to="/">
            ...
            <li @click="toggleSideNav" class="nav-item px-6 py-2 hvr-shadow mt-1">
              <router-link class="nav-link d-flex align-items-center justify-content-center" to="/screener">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-minus-fill me-2" viewBox="0 0 16 16">
                ...
                <em class="bi bi-calendar-event-fill"></em>
                <span class="">Screener</span> 
              </router-link>
            </li>
            <li @click="toggleSideNav" class="nav-item px-6 py-2 hvr-shadow mt-1">
              <router-link  class="nav-link d-flex align-items-center justify-content-center" to="/practice">
            ...
            <li @click="toggleSideNav" class="nav-item px-6 py-2 hvr-shadow mt-1">
              <router-link  class="nav-link d-flex align-items-center justify-content-center" to="/information">
            ...
            <li @click="toggleSideNav" class="nav-item px-6 py-2 hvr-shadow mt-1 ">
              <router-link class="nav-link d-flex align-items-center justify-content-center" to="/statistics">
...
<style scoped>
  ...
  .navbar-light .navbar-nav .nav-link.active, .navbar-light .navbar-nav .nav-link.active:hover {
    ...
    background-color: rgba(226, 224, 224, 0.103);
