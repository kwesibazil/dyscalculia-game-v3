    ...
    <div class="mb-5">
      ...
      <div>
        <div class="input-group input-group-lg">
          ...
          <input :type="inputType('signIn')" v-model="input.pwd"  class="form-control px-5 fs-6 rounded-2" name="password"  autocomplete="current-password"  placeholder="password" pattern="^(?=.*[\d])(?=.*[A-Z])(?=.*[a-z]).{8,30}$" required>
      ...
      <div>
        ...
        <div class="d-flex alert align-items-center py-2 mb-0 mt-2"
          :class="{'alert-danger': !alertSuccess('signIn'), 'alert-success': alertSuccess('signIn'),
