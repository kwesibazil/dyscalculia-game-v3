        ...
        <div class="d-flex flex-column justify-content-between h-100 ">
          <ul class="navbar-nav d-flex flex-column justify-content-between h-50">
            <li @click="toggleSideNav" class="nav-item px-6 py-2 hvr-shadow mt-3 "><!-- mt-md-3 -->
              <router-link class="nav-link active d-flex align-items-center justify-content-center" aria-current="page" to="/dashboard">
            ...
            <li @click="toggleSideNav" class="nav-item px-6 py-2 hvr-shadow mt-1">
              <router-link class="nav-link d-flex align-items-center justify-content-center" to="#">
