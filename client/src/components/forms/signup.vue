    ...
    <div class="mb-5">
      ...
      <div>
        <div class="input-group input-group-lg">
          ...
          <input :type="inputType('signUp')"  name="password"  class="form-control transparentInput px-5 fs-6 rounded-2"  autocomplete="current-password"  placeholder="password" pattern="^(?=.*[\d])(?=.*[A-Z])(?=.*[a-z]).{8,30}$" required>
