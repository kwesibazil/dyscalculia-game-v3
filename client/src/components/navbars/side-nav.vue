    ...
    <div class="sideNav shadow d-flex justify-content-center bg-white h-100" :class="{'sideNav--collapse': !isVisible('sideNav')}">
      <nav class="navbar navbar-light py-0 h-100 px-xl-3 ">
        <div class="d-flex flex-column justify-content-between h-100">
          ...
          <div @click="currentLink"  id="sideNavLinks" ref="sideNavLinks" class="active navbar-nav d-flex flex-column justify-content-between align-items-start h-50">
            ...
            <router-link @click="toggleSideNav" class="nav-link d-flex align-items-center justify-content-start rounded-2 px-6 py-2 hvr-shadow mt-1  hvr-icon-bob" to="/screener">
            ...
            <router-link @click="toggleSideNav" class="nav-link d-flex align-items-center justify-content-start rounded-2 px-6 py-2 hvr-shadow mt-1 hvr-icon-spin" to="/practice">
