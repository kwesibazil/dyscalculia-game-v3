  ...
  <form class="bg-white h-100 p-3 p-sm-4 pb-0 mt-2 "  @submit.prevent="submitForm">
    <div class="mb-5">
      <div class="input-group input-group-lg">
        ...
        <input type="email" v-model="input.email"  class="form-control  py-sm-2 px-5 fs-6 rounded-2" name="email" autocomplete="username" placeholder="email"  required>
    ...
    <div>
      <div class="input-group input-group-lg">
        ...
        <span class="passwordIcon">
          ...
          <svg @mousedown="toggleInputType('password')"  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye opacity-50" v-show="!hidePassword"  viewBox="0 0 16 16">
